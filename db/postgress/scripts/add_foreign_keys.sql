...
ALTER TABLE store_returns ADD CONSTRAINT fk_store_returns_2 FOREIGN KEY (sr_item_sk ) REFERENCES store_sales (ss_item_sk);
...
ALTER TABLE store_returns ADD CONSTRAINT fk_store_returns_5 FOREIGN KEY (sr_ticket_number ) REFERENCES store_sales (ss_ticket_number);
