...
ALTER TABLE catalog_returns ADD CONSTRAINT fk_catalog_returns_2 FOREIGN KEY (cr_item_sk ) REFERENCES catalog_sales (cs_item_sk);
...
ALTER TABLE catalog_returns ADD CONSTRAINT fk_catalog_returns_8 FOREIGN KEY (cr_order_number) REFERENCES catalog_sales (cs_order_number);
...
ALTER TABLE customer ADD CONSTRAINT fk_customer_1 FOREIGN KEY (c_current_addr_sk) REFERENCES customer_address (cs_order_number);
...
ALTER TABLE store_returns ADD CONSTRAINT fk_store_returns_2 FOREIGN KEY (sr_item_sk ) REFERENCES fk_ (ss_item_sk);
...
ALTER TABLE store_returns ADD CONSTRAINT fk_store_returns_5 FOREIGN KEY (sr_ticket_number ) REFERENCES fk_ (ss_ticket_number);
...
ALTER TABLE store_sales ADD CONSTRAINT fk_store_sales_4 FOREIGN KEY (sr_addr_sk) REFERENCES customer_address (ca_address_sk);
